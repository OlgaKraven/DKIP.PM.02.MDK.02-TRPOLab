...
### **1.0. Цель работы**
Целью лабораторной работы является освоение методов анализа предметной области, направленных на понимание логики функционирования бизнес-процессов, выявление ключевых ролей и объектов системы.
